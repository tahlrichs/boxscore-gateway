#!/usr/bin/env npx tsx
/**
 * Sync Full NCAAM 2025-26 Season
 * 
 * This script populates the games and game_dates tables with all NCAAM season data.
 * 
 * Usage: npx tsx scripts/syncNCAAMSeason.ts [--reset-limits]
 */
...
async function main() {
  ...
  const seasonId = 'ncaam_2025-26';
  const league = 'ncaam';
  
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('NCAAM 2025-26 Season Sync');
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  // Run the sync
  console.log('🚀 Starting NCAAM sync...\n');
  ...
  console.log('🏀 NCAAM Game Dates Breakdown:');
  ...
  console.log('✅ NCAAM sync complete!\n');
}
