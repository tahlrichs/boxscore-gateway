#!/usr/bin/env npx tsx
/**
 * Sync Full NFL 2025 Season
 * 
 * This script populates the games and game_dates tables with all NFL season data.
 * 
 * Usage: npx tsx scripts/syncNFLSeason.ts [--reset-limits]
 */
...
async function main() {
  ...
  const seasonId = 'nfl_2025';
  const league = 'nfl';
  
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('NFL 2025 Season Sync');
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  console.log('🏈 NFL Game Dates Breakdown:');
